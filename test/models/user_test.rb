...
class UserTest < ActiveSupport::TestCase
  ...
  test "should not save user with duplicate email" do
    ...
    user2 = User.new(email: "romanch@gmail.com", password: "1234567890", password_confirmation: "1234567890", admin: false)
  ...
  test "should not save user with password more than 128 characters" do
    user = User.new(email: @unique_email, password: "123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890", admin: false)
