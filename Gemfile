...
# Use Devise for authentication [ user accounts ]
gem 'devise', '~> 4.8'

# Use rolify for  adding roles to resources [ user roles ]
gem 'rolify'

# Use rubocop to lint ruby code [ rubocop.org ]
gem 'rubocop', require: false

# Use rubocop-rails to lint rails code [ rubocop.org ]
